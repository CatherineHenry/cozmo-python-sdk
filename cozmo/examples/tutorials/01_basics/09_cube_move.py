...
def cozmo_program(robot: cozmo.robot.Robot):
    ...
    while True:
        # print(f"Last moved time: {cube3.last_moved_time}")
        # print(f"last observed time: {cube3.last_observed_time}")
        # print(f"last tapped time: {cube3.last_tapped_time}")
        acceleration = cube3.acceleration
        ...
        if acceleration is not None:
            ...
            vertical = "UP" if x < 0 else "DOWN"
            horizontal = "LEFT" if y < 0 else "RIGHT"
